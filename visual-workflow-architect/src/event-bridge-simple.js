...
window.WorkflowArchitectEventBridge = {
  ...
  handleContainerUpdate: function (eventData) {
    console.log("WorkflowArchitectEventBridge: Container update requested", eventData);
    this.instance.publishState("pending_update", JSON.stringify(eventData));
  ...
  handleSequenceUpdate: function (eventData) {
    console.log("WorkflowArchitectEventBridge: Sequence update requested", eventData);
    this.instance.publishState("pending_update", JSON.stringify(eventData));
  ...
  handleWorkflowUpdate: function (eventData) {
    console.log("WorkflowArchitectEventBridge: Workflow update requested", eventData);
    this.instance.publishState("pending_update", JSON.stringify(eventData));
  ...
  handleSubgroupAdd: function (eventData) {
    console.log("WorkflowArchitectEventBridge: Subgroup add requested", eventData);
    this.instance.publishState("pending_update", JSON.stringify(eventData));
  ...
  handleSubgroupUpdate: function (eventData) {
    console.log("WorkflowArchitectEventBridge: Subgroup update requested", eventData);
    this.instance.publishState("pending_update", JSON.stringify(eventData));
  ...
  handleSubgroupCreationTrigger: function (eventData) {
    console.log("WorkflowArchitectEventBridge: Subgroup creation trigger", eventData);
    this.handleSubgroupAdd(eventData);
  },
};

console.log("WorkflowArchitectEventBridge: Simple event bridge loaded successfully");
